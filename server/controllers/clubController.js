...
console.log('[clubController] v4.478.0 — Evento/Convención: colores + hero + menú reordenable + secciones editables + footer configurable | scroll-to-top | correo: envío directo vía Resend (multi-destinatario) + Enviados persistentes + recepción vía Resend (firma Svix no bloqueante + logs) + botón Enviar robusto');
