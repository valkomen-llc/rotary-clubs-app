...
console.log('[clubController] v4.471.0 — Evento/Convención: colores + hero + menú reordenable (fijos + adicionales) + secciones editables + visibilidad de noticias + footer configurable | scroll-to-top en cambio de ruta');
