...
export const updateClub = async (req, res) => {
    ...
    const {
        ...
        storeActive, logoHeaderSize, autoGenerateCalendar, mapStyle, trfCredibilityVisible, honoraryMembersVisible, governorsVisible, authorsVisible, paymentBlocks, currency, defaultLanguage,
