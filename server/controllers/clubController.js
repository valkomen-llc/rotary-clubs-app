...
console.log('[clubController] v4.477.0 — Evento/Convención: colores + hero + menú reordenable + secciones editables + footer configurable | scroll-to-top | correo: envío directo vía Resend (multi-destinatario) + Enviados persistentes + recepción vía Resend con verificación de firma Svix + botón Enviar robusto');
