...
console.log('[clubController] v4.458.0 — Evento/Convención: colores + hero + menú + sección "gente de acción" editable');
...
export const updateClub = async (req, res) => {
    ...
    const {
        ...
        primaryColor, secondaryColor, actionSectionBg, joinSectionBg, areasSectionBg, footerBg, copyrightBg, copyrightTextColor, buttonBg, buttonHoverBg, buttonTextColor, eventHeroImages, eventNavMenu, actionContent, logo, footerLogo, endPolioLogo, rotaractLogo, interactLogo, youthExchangeLogo, favicon, status,
