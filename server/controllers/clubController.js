...
console.log('[clubController] v4.472.0 — Evento/Convención: colores + hero + menú reordenable + secciones editables + footer configurable | scroll-to-top | correo: envío directo desde el dominio del club vía Resend');
