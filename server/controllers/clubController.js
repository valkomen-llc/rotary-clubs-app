...
console.log('[clubController] v4.467.0 — Evento/Convención: colores + hero + menú + secciones editables (incl. Áreas de Interés) + visibilidad de noticias + footer configurable');
