...
console.log('[clubController] v4.470.0 — Evento/Convención: colores + hero + menú (con ítems adicionales) + secciones editables + visibilidad de noticias + footer configurable | scroll-to-top en cambio de ruta');
