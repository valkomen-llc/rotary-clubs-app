...
const NewsSection = () => {
  ...
  return (
    <section className="bg-white py-16 md:py-20">
      {/*
        El MISMO ancho que «Únete a Rotary» (`max-w-7xl`), no uno propio. Las
        dos son secciones de la portada estándar y una más angosta que la otra
        se lee como un desalineo, no como una decisión. Al tocar este ancho,
        mirar `JoinSection.tsx`.
      */}
