        ...
        <AdminLayout>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Tienda y Productos</h1>
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                            ...
                                            <div className="aspect-square rounded-xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors relative">
                                                ...
                                                <input type="file" multiple accept=".jpg,.jpeg,.png,.webp,.svg" className="absolute inset-0 opacity-0 cursor-pointer" onChange={handleImageUpload} disabled={uploading} />
                                            </div>
                                        </div>
                                    </div>
