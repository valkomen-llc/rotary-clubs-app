            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Galería del evento — v4.607
                            Mosaico de tres columnas con miniaturas del mismo tamaño, que
                            se pasan en grupos. Al pulsar una, el visor la muestra completa
                            sin recortar. Antes era una sola imagen grande cuyo alto cambiaba
                            con cada foto, y la sección quedaba despareja. */}
                        {hasImages && (
                            <MediaGallery
                                images={event.images}
                                className="my-10"
                                altPrefix={`Imagen de ${event.title}`}
                            />
                        )}
