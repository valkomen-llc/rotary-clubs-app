    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 md:py-28 bg-rotary-concrete">
        <div className="max-w-4xl mx-auto px-6 text-gray-800 space-y-16">
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#333333] mb-6">Los orígenes de Rotary</h2>
          ...
          <div className="space-y-16">
            <div>
              <h2 className="text-3xl font-bold text-[#333333] mb-6">El nacimiento de Origen</h2>
              <p className="text-lg leading-relaxed text-gray-800 whitespace-pre-line">
            ...
            {/* Mirando al futuro */}
            <div className="mb-12">
              <h3 className="text-3xl font-bold text-[#333333] mb-6">Mirando al futuro</h3>
