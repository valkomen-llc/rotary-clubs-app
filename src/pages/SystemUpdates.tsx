...
export const SYSTEM_UPDATES: UpdateItem[] = [
    ...
    },
    {
        ...
        description: 'Tres cambios que van juntos porque forman un mismo recorrido. El primero es de forma: el formulario de Registro Internacional se veía distinto del de Postular Proyecto —campos más bajos, rótulos más pequeños, sin íconos, sin barra de avance— aunque los dos son el mismo trámite para quien los llena. Ahora son idénticos: los dos formularios usan literalmente las mismas piezas de interfaz, de modo que el espaciado, la tipografía, los bordes, el tamaño de los campos, la distribución en dos columnas, los mensajes de error y el comportamiento en el celular son los mismos y seguirán siéndolo, porque cualquier ajuste futuro se hace en un solo lugar. El teléfono estrena el selector de país con banderas e indicativo que ya tenía la postulación. El segundo cambio es una simplificación: desaparece el campo "Idioma" del paso de datos personales. El idioma con el que la persona navega ya lo elige en el selector del encabezado y es el que decide qué registro se le ofrece; volver a preguntarlo dentro del formulario duplicaba un dato que el sitio ya conoce y que además podía contradecirlo. No se pide, no es obligatorio, no se envía y no se valida. Se conserva, eso sí, "Idioma preferido durante el evento", que es otra cosa: sirve para organizar la traducción y las salas, no para navegar. Las inscripciones anteriores conservan intacto lo que hubieran guardado. El tercero es el de fondo: al inscribirse, la persona crea ahora su contraseña —en el mismo bloque "Crea tu clave de acceso" que ya usa la postulación de proyectos, con confirmación, mínimo de ocho caracteres, ojo para revelar lo escrito y aviso inmediato si las dos no coinciden— y con ella nace su cuenta de Asistente al Evento. Desde "Mi inscripción" cada inscrito consulta cuando quiera el evento al que se registró, su categoría, el estado del formulario, el estado y el valor del pago con su moneda, la fecha de registro, el código de inscripción con su código QR, sus acompañantes, el comprobante, sus observaciones, los correos que le hemos enviado y el rastro de todas las actualizaciones de su inscripción, incluidas las que hace el equipo desde el panel y las que confirma la pasarela de pagos. Es un espacio de sólo lectura sobre lo suyo: no ve inscripciones de otras personas, ni proyectos, ni pagos ajenos, ni ninguna función administrativa. El correo identifica a la persona, no a la inscripción: quien se registre a varias categorías o vuelva en la edición siguiente conserva una sola cuenta y ve su historial separado por evento. Si el correo ya tiene cuenta, no se crea otra: se vincula la inscripción nueva a la de siempre, y para hacerlo se pide la contraseña que ya usa, con un mensaje que explica cómo restablecerla si no la recuerda. El ingreso es el mismo formulario del encabezado que ya usaban el administrador y el Gestor de Proyectos —el sistema reconoce solo a cuál de los tres pertenece cada correo y lo lleva a su panel—, y trae recuperación de contraseña por correo, sesiones con caducidad y permisos propios de consulta, distintos de los de gestión de proyectos. Quien haya pagado antes de esta versión no queda por fuera: al confirmarse un pago, el sistema crea la cuenta que falte y la persona la estrena desde "Olvidé mi contraseña". Cada ingreso, correcto o fallido, queda registrado con su fecha.',
        date: new Date().toISOString(),
        tags: ['eventos', 'inscripciones', 'cuentas', 'roles', 'seguridad', 'diseno', 'feature'],
        type: 'feature'
    },
    {
        version: '4.654.0',
    ...
    },
    {
        ...
        description: 'La ficha pública de cada evento deja de tener un único botón de inscripción y pasa a mostrar dos, claramente diferenciados y enlazados con las categorías que están configuradas en el panel. El primero es el botón principal y cambia según quién esté mirando la página: a quien entra desde Colombia, o con el sitio en español de Colombia, le aparece "Registro Nacional" con el valor en pesos; a quien entra desde cualquier otro país, o con el sitio en otro idioma, le aparece "Registro Internacional" con el valor en dólares. Debajo del principal queda siempre un segundo botón, "Registro CADRES", visible tanto para visitantes nacionales como internacionales, para que los asistentes técnicos siempre tengan su acceso propio sin importar desde dónde entren. Cada botón muestra el valor y la moneda de su categoría y abre el formulario de esa categoría y de ninguna otra. Ese es el cambio de fondo: ya no hay un formulario único con las tres opciones a la vista. Quien entra por el registro internacional ve solamente los campos, los precios y los mensajes del registro internacional —su país de residencia, sus fechas de viaje, su hospedaje, su contacto de emergencia— y en ningún momento aparecen datos del registro nacional. Quien entra por el nacional ve solamente lo suyo: departamento, ciudad, distrito y club, con el valor en pesos. Y CADRES es igualmente independiente, con su experiencia técnica, sus áreas de especialidad y su disponibilidad. La separación no es sólo visual: el servidor entrega al navegador únicamente la categoría por la que se entró, de modo que los precios y los campos de las otras dos ni siquiera viajan hasta el computador de quien se está inscribiendo. Una vez dentro del formulario, la categoría queda bloqueada y no se puede cambiar desde allí; para elegir otra hay que volver a la ficha del evento, que es donde están los botones. El paso de selección de categoría desaparece del asistente cuando se entra por un botón, así que el formulario arranca directamente en los datos personales. La detección de si alguien es nacional o internacional funciona como una sugerencia, no como una barrera: el otro camino sigue estando a un clic en la misma ficha. Primero se mira el país desde el que se conecta el visitante y, si no se puede determinar, se usa el idioma que tenga puesto el sitio. En el panel se agregó una pestaña "Botones" dentro de la sección Registro del evento, donde se configura todo esto por evento: el texto de cada botón, si está activo, en qué orden aparece, a qué categoría lleva, qué países cuentan como nacionales y qué botón principal se muestra por defecto en cada versión lingüística del sitio. También se define qué pasa cuando una categoría está desactivada o fuera de sus fechas: si se escribe un mensaje, el botón se muestra apagado con esa explicación; si se deja vacío, el botón simplemente no aparece, para no dejar botones que no llevan a ninguna parte. El precio, la moneda y el formulario se siguen definiendo en la categoría y no en el botón, de manera que lo que anuncia el botón y lo que cobra el formulario nunca puedan discrepar. Por último, cada inscripción guarda ahora también la versión de tarifa con la que se abrió, además del evento, la categoría, el precio y la moneda: si más adelante se cambia un precio, queda registrado con cuál entró cada persona.',
        date: new Date().toISOString(),
        tags: ['eventos', 'inscripciones', 'feria-de-proyectos', 'segmentacion', 'multimoneda', 'feature'],
        type: 'feature'
    },
    {
        version: '4.649.0',
    ...
    },
    {
        ...
        description: 'El módulo de Eventos pasa a manejar la inscripción completa de la Feria de Proyectos, empezando por la XII Rotary Project Fair Colombia 2027 en Valledupar. Cada versión de la feria funciona como una entidad aparte: tiene su número de edición, su sede, sus fechas, sus categorías, sus precios, sus formularios, sus pagos y sus reportes, y nada se mezcla entre ediciones. Cuando llegue la XIII, se crea el evento y se le clona la estructura de la XII con un botón; no hay que tocar el código. Dentro de cada edición hay tres categorías de participante, y la que se elige define todo lo demás. "Rotario Internacional" es para quienes residen fuera de Colombia y viajan a conocer los proyectos postulados, establecer alianzas y apoyar iniciativas alineadas con las áreas de enfoque de Rotary: su precio se publica y se cobra en dólares, y su formulario pide además país de residencia, fechas estimadas de llegada y salida, hospedaje previsto, idioma preferido, si necesita carta de invitación para la visa y un contacto de emergencia. "Rotario Nacional" es para quienes residen en Colombia y se inscriben para asistir, aprender, hacer networking y participar en las actividades: su precio se muestra en pesos colombianos y su formulario pide departamento, ciudad, distrito y club. "CADRES" es para los asistentes técnicos que apoyan a los clubes postulantes en la estructuración, revisión y presentación de los proyectos ante los rotarios internacionales: el administrador decide por evento si esa categoría se cobra en dólares o en pesos, y su formulario pide experiencia técnica, áreas de especialidad, disponibilidad durante la feria y los proyectos o clubes que va a acompañar. Sobre las monedas: si una categoría publica su precio en pesos pero la pasarela liquida en dólares, la plataforma convierte con la tasa que el administrador deja configurada en la edición y guarda en la inscripción las tres cosas —el valor original en pesos, el valor convertido y la tasa que se usó—, de modo que la conciliación no queda al aire. Y el precio de cada inscripción se congela en el momento en que la persona envía el formulario: cambiar después el precio o la moneda de una categoría no altera a quien ya se inscribió. En el panel del evento aparece una sección "Categorías de Registro" donde se crean, editan, activan o desactivan categorías, con nombre, descripción, moneda, precio, cupo, fechas de apertura y cierre, beneficios incluidos, reglas de acompañantes y campos adicionales propios. Una categoría que ya tenga inscripciones no se puede borrar: se desactiva. El formulario público se convirtió en un asistente por pasos que arranca eligiendo la categoría y a partir de ahí muestra sólo lo que esa categoría necesita. Guarda solo el avance cada pocos segundos, deja volver atrás a cualquier paso ya visitado, valida a medida que se escribe y evita registros duplicados: si alguien vuelve con el mismo correo, retoma su inscripción en vez de crear otra. El titular puede indicar si asiste con acompañantes, cuántos y los datos de cada uno; cada acompañante queda ligado a la inscripción principal y suma su valor al total según lo que se haya configurado. El pago sigue haciéndose con la pasarela Stripe que ya estaba integrada. La inscripción sólo pasa a "Pago confirmado" cuando lo dice el webhook de Stripe, nunca por el simple regreso del navegador, y de cada transacción quedan guardados la sesión de pago, el Payment Intent, el cargo, el cliente, la moneda, el valor, la tasa de conversión cuando aplica, el método de pago, la fecha, el estado y el reembolso si lo hubo. Confirmado el pago, la inscripción recibe un código único (RPF12-XXXXX), se envía el comprobante por correo y queda lista para la acreditación. Si el pago falla o queda pendiente, la inscripción se conserva y se puede reintentar sin duplicarla. El panel suma "Gestión de Inscripciones del Evento": un tablero con inscritos totales y por categoría, confirmados, pendientes, pagos fallidos, reembolsos, recaudo por moneda, acompañantes, países representados, distritos, clubes y evolución de registros por fecha; y una tabla con filtros por categoría, estado, estado del pago, país, distrito, club, moneda, etiquetas, fechas y con o sin acompañantes. Cada inscripción abre una ficha con todos sus datos, sus acompañantes, sus pagos, los eventos de Stripe, las comunicaciones enviadas, las notas internas y el historial completo de cambios, donde cada movimiento queda con quién lo hizo, cuándo y con qué comentario. Los participantes se pueden segmentar con etiquetas —Internacional, Nacional, CADRES, Pago confirmado, Pendiente, Con acompañantes, Requiere visa, Requiere traducción, Necesidad alimentaria, Prioridad logística o las que el equipo quiera crear—, y los estados van de borrador y registro iniciado hasta acreditado, asistió y no asistió, pasando por lista de espera, cancelado y reembolsado. Para el día del evento hay una pantalla de acreditación: se busca por nombre, código, correo o documento, se marca la llegada del titular y de cada acompañante, y se imprimen las escarapelas con su código QR. Todo se puede exportar a CSV y Excel respetando los filtros que estén puestos en pantalla —el Excel trae una hoja aparte con los acompañantes—, y hay un informe ejecutivo en PDF con el resumen por categoría, moneda, país, distrito y club.',
        date: new Date().toISOString(),
        tags: ['eventos', 'feria-de-proyectos', 'inscripciones', 'stripe', 'pagos', 'multimoneda', 'acreditacion', 'reportes', 'feature'],
        type: 'feature'
    },
    {
        version: '4.647.0',
    ...
    },
    {
        ...
        description: 'Los sitios de Evento o Convención ahora pueden editar el bloque "Únete a Rotary": título (con palabras resaltadas y saltos de línea), texto, texto y enlace del botón, e icono (emoji). Está en Configuración → Identidad → "Sección Únete a Rotary (Contenido)". La imagen del bloque se sigue cambiando en "Imágenes del Sitio". Si un campo se deja vacío, se usa el texto por defecto.',
        date: new Date().toISOString(),
        tags: ['identidad', 'contenido', 'unete-a-rotary', 'cta', 'eventos', 'convenciones', 'feature'],
        type: 'added'
    },
    {
        version: '4.460.0',
    ...
    },
    {
        ...
        date: new Date().toISOString(),
        description: 'Se ha optimizado la resolución de metadatos de comunidades para buscar el nombre real a nivel de API si no se encuentra en el caché ligero de grupos. Adicionalmente, al importar o añadir contactos dentro de una Comunidad, ahora se despliega un selector dinámico que permite elegir de forma obligatoria a cuál de los subgrupos (grupos hijos) se agregarán los miembros seleccionados, logrando una segmentación perfecta.',
        tags: ['whatsapp', 'communities', 'groups', 'feature'],
        type: 'feature'
    },
    {
    ...
    {
        version: '4.428.2',
        title: 'Fix: Resolución de Bug en CRM (Vercel Build #2)',
        date: new Date().toISOString(),
        description: 'Se ha corregido un segundo error de resolución de módulos (CustomFieldsManager) que impedía el despliegue en Vercel por archivos bloqueados.',
        type: 'feature',
        impact: 'high',
        author: 'Antigravity AI',
        tags: ['CRM', 'Build Fix', 'Hotfix']
    ...
    },
    {
        ...
        description: 'Blindaje del Content Studio ante restricciones de modelos de OpenAI.',
        type: 'major',
        details: [
            'Implementación de detección automática de disponibilidad de DALL-E 3.',
            'Sistema de salto inteligente a modelos alternativos ante errores de "Modelo no encontrado".',
            'Fallback de emergencia a DALL-E 2 para garantizar la regeneración ante bloqueos de cuenta.',
            'Optimización de la comunicación con la API de imágenes para mayor estabilidad.',
            'Aseguramiento de continuidad operativa incluso con restricciones de Tier en OpenAI.'
        ]
    },
    {
        version: 'v4.305',
    ...
    },
    {
        ...
        description: 'Blindaje total del motor de regeneración cinematográfica para máxima disponibilidad.',
        type: 'major',
        details: [
            'Implementación de procesamiento de imagen previo (Sharp) para eliminar fallos de tamaño.',
            'Sistema de redundancia total: Triple-pass para garantizar la entrega de contenido.',
            'Optimización de prompts para máxima compatibilidad con filtros de seguridad.',
            'Gestión avanzada de excepciones para evitar bloqueos en el flujo de trabajo.',
            'Garantía de regeneración cinematográfica incluso en condiciones extremas de API.'
        ]
    },
    {
        version: 'v4.299',
