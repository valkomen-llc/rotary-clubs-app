...
const FeriasManagement: React.FC = () => {
    ...
    const fetchAssociations = async () => {
        try {
            ...
            const [assocRes, usersRes] = await Promise.all([
                fetch(`${import.meta.env.VITE_API_URL || '/api'}/admin/clubs?type=Feria%20de%20Proyectos`, { headers: { 'Authorization': `Bearer ${token}` } }),
    ...
    return (
        <AdminLayout>
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Gestión de Ferias de Proyectos</h1>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden animate-in zoom-in duration-200 flex flex-col max-h-[90vh]">
                        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 flex-shrink-0">
                            <h2 className="text-lg font-bold text-gray-800">
                                {editingClub ? 'Editar Asociación' : 'Nueva Feria'}
                            </h2>
