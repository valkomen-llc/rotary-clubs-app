...
//
// La aplicación crea 56 tablas en tiempo de ejecución que no están en el
...
// EventRegistrationMessage, EventCompletedRegistration (v4.943, las
// inscripciones completadas por fuera de la página) y EventImportBatch
// (v4.950, los lotes del motor de importación histórica), las dos del módulo de
...
// `select` en media plataforma —así que una columna declarada y todavía
// inexistente deja esas consultas en 500— y lo que caería en 500 ahí es el
// webhook del COBRO. Ver `ensureDisbursementSchema.js`.
